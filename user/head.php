...
<meta name="keywords" content="<?php echo $conf["title"] ?>,忧乐网络提供技术支持"/>
<meta name="description" content="<?php echo $conf["title"] ?>,忧乐网络提供技术支持。！"/>
  ...
  <div class="lyear-layout-container">
    ...
    <aside class="lyear-layout-sidebar">
      ...
      <div id="logo" class="sidebar-header">
        <a href="index.php"><p><font color="#ff2000">忧乐网络</font></p>
      </div>
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item"> 
            <a href="msg.php">
            <i class="mdi mdi-currency-jpy"></i> 在线轰炸</a> 
            </li>

            <li class="nav-item"> 
            <a href="log.php">
            <i class="mdi mdi-alphabetical"></i>轰炸日志</a> 
            </li>

            <li class="nav-item"> 
            <a href="km.php">
            <i class="mdi mdi-alert-box"></i>卡密充值</a> 
            </li>
            <li class="nav-item"> 
            <a href="set.php">
            <i class="mdi mdi-monitor-multiple"></i> 账号管理</a> 
            </li>
            <li class="nav-item"> 
            <a href="keyset.php">
            <i class="mdi mdi-elephant"></i> 重置KEY</a> 
            </li>
            <li class="nav-item"> 
            <a href="../doc.php">
            <i class="mdi mdi-alert-decagram"></i>API文档</a> 
            </li>
          </ul>
        </nav>
          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                <span><?php echo $row['user']?> <span class="caret"></span></span>
              </a>
