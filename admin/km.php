...
for ($i = 0; $i < $num; $i++) {
	$km = random("18");
$sql="insert into `msg_km` (`km`,`money`,`status`) values ('$km','$money','0')";
$DB->query($sql);
        ...
        <div class="panel-body">
          <form action="./km.php" method="post" class="form-horizontal" role="form">
            <div class="input-group">
              ...
              <input type="number" name="money" value="<?=@$_POST['money']?>" class="form-control" placeholder="100" autocomplete="off" required/>
            </div><br/>
            <div class="input-group">
